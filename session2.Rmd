...
The  [Structural Classification of Proteins (SCOP)](http://scop.mrc-lmb.cam.ac.uk) systematically groups protein folds in superfamilies, of which some are the most common DNA-binding proteins. 

The next table shows superfamilies with more than 20 non-redundant complexes in the [Protein Data Bank](http://www.rcsb.org) as of Feb 2023, as annotated in the database [3d-footprint](https://3dfootprint.eead.csic.es):
...
![Color map illustrating the Plant-TFClass structural classification, from @BlancMathieu2023](pics/plant-tf-class.jpg)
...
![Information content of structure-derived DNA motifs of proteins belonging to several SCOP superfamilies as of Feb 2023, after @ContrerasMoreira2010](pics/superfam_specificity.png)
