...
In the course of research projects there are several aspects that need to be addressed in order to ensure your work can reproduced by others. They are summarized in the next subsections.
...
In order to make sure your data analysis protocols are reproducible they should be described in the form of documented source code with versioned data and software.
