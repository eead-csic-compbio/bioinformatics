...
### Viewing the aligned reads using IGV app

The online Integrative Genomics Viewer ([IGV](https://igv.org/app)) is a useful interactive tool to explore visually the genomic data resulting from your analysis. We are going to use it in this section of the session to display the alignments we have generated.
